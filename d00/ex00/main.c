...
int main(int argc, char **argv)
{
	...
	--------------------*/
	if (argc == 2)
		printf("price for the art \'%s\' is %d\n", argv[1], searchPrice(arts, argv[1]));
	else {
		printf("price for the art \'%s\' is %d\n", "Guernica", searchPrice(arts, "Guernica"));
		printf("price for the art \'%s\' is %d\n", "The Sculptor, Germaine Richier", searchPrice(arts, "The Sculptor, Germaine Richier"));
		printf("price for the art \'%s\' is %d\n", "INTERIOR - WHITE MOUNTAINS", searchPrice(arts, "INTERIOR - WHITE MOUNTAINS"));
		printf("price for the art \'%s\' is %d\n", "Not a real painter", searchPrice(arts, "Not a real painter"));
	}
	return (0);
}
