...
int main(int argc, char **argv)
{
	...
	--------------------*/
	if (argc == 2)
		printf("price for the art \'%s\' is %d\n", argv[1], searchPrice(arts, n, argv[1]));
	else {
		printf("price for the art \'%s\' is %d\n", "Guernica", searchPrice(arts, n, "Guernica"));
		printf("price for the art \'%s\' is %d\n", "The Sculptor, Germaine Richier", searchPrice(arts, n, "The Sculptor, Germaine Richier"));
		printf("price for the art \'%s\' is %d\n", "INTERIOR - WHITE MOUNTAINS", searchPrice(arts, n, "INTERIOR - WHITE MOUNTAINS"));
		printf("price for the art \'%s\' is %d\n", "Not a real painter", searchPrice(arts, n, "Not a real painter"));
	}
	return (0);
}
