...
int main(int argc, char **argv)
{
	...
	if (argc > 1)
		...
		printf("price for the art \'%s\' is %d\n", "The Sculptor, Germaine Richier", searchPrice(dict, "The Sculptor, Germaine Richier"));
		printf("price for the art \'%s\' is %d\n", "INTERIOR - WHITE MOUNTAINS", searchPrice(dict, "INTERIOR - WHITE MOUNTAINS"));
		printf("price for the art \'%s\' is %d\n", "Not a real painter", searchPrice(dict, "Not a real painter"));
	}
